...
const Input = ({ label, inputValue, onChange, placeHolderText, inputWidth, labelWidth }) => {
	return (
		<div className="flex items-center mb-4">
			<label className={`mb-2 text-gray-700 font-semibold mr-2 w-${inputWidth}`}>{label}</label>
			<input
				type="text"
				value={inputValue}
				onChange={onChange}

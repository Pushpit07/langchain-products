	...
	return (
		<nav className="fixed z-10 top-0 bg-gray-50 text-gray-800 w-full p-4 grid grid-cols-3 items-center">
			<a href="/" className={`text-center`}>
				AWESOME AI AGENTS USING LANGCHAIN
			</a>
			{isClient && <HamburgerMenu />} {/* Render HamburgerMenu component on the client side */}
			<p className={`text-center`}>A Nights & Weekends Project</p>

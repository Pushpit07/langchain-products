...
const Memory = () => {
	...
	const handleSubmitPrompt = async () => {
		...
		try {
			...
			// Add the bot message
			setMessages((prevMessages) => [...prevMessages, { text: searchRes.output.response, type: "bot", sourceDocuments: null }]);
			...
			<TwoColumnLayout
				leftChildren={
					<>
						<PageHeader
							...
							boldText="Let's see if it can remember your name and favourite food. This tool will let you ask anything you want, and it will try to answer based on the knowledge it has."
				...
				rightChildren={
					<>
						...
						<PromptBox prompt={prompt} handleSubmit={handleSubmitPrompt} error={error} handlePromptChange={handlePromptChange} />
					</>
				}
			/>
		</>

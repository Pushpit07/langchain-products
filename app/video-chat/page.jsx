...
const VideoChat = () => {
	// Setting a default YouTube video so we don't have to copy and paste this every time
				...
				leftChildren={
					<>
						<PageHeader
							...
							description="It uses the YouTube API, Text Splitters, and the Conversational Retrieval QA CHain."
						/>
					</>
				}
				rightChildren={

...
export default async function getVideoMetaData(videoId) {
	// First, we need to make sure we have our GOOGLE_YOUTUBE_API_KEY set up
	// https://console.cloud.google.com/apis/
	// Look up the YouTube Data API V3
	// Enable API key
	// Copy into .env as GOOGLE_YOUTUBE_API_KEY
	// Configure Next.Config.JS
	const url = `https://www.googleapis.com/youtube/v3/videos?id=${videoId}&key=${process.env.GOOGLE_YOUTUBE_API_KEY}&part=snippet,contentDetails,statistics,status`;
